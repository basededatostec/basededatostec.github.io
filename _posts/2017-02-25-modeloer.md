...
<br><br>Al entregar nuestro modelo surgeron alguna dudas en nuestro profesor;

<br><br>1.- La relación "suministra" indica que que UN productos los suministran MUCHOS proveedores, lo cual indica que un el negocio debe tener un proveedor por cada producto, esto es real??

<br><br>La afirmacion fue erronea, asi que corregimos nuestro modelo, la cardinalidad no era <b>1:N</b> es <b>N:1</b>, "un producto sólo puede ser suministrado por un proveedor, y un proveedor puede suministrar varios productos", por lo que corregimos nuestro modelo.</p>

Descarga el primer modelo <b>con error</b> dando clic en el siguiente [enlace](https://drive.google.com/uc?export=download&id=0B0tLjk4fF3eYT0E2bHBGVlZiNlE "clic para descargar la presentación") 
